...
- (void) startup
{
    if (_session == nil)
    {
        ...
        [_videoConnection setVideoOrientation:AVCaptureVideoOrientationPortrait]; // changed here
...
- (void) captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection
{
    ...
    @synchronized(self)
    {
        ...
        if ((_encoder == nil) && !bVideo)
        {
            ...
            _encoder = [VideoEncoder encoderForPath:path Height:_cx width:_cy channels:_channels samples:_samplerate]; // changed here
        }
        if (_discont)
        {
            if (bVideo)
